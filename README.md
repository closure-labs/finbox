...
This checkout targets the sandbox repository
[closure-labs/finbox](https://github.com/closure-labs/finbox). Production images
and the running workstation remain on their existing delivery path until the
sandbox passes image, ISO and VM acceptance.

| Recipe | Foundation | Kernel | Sandbox tags |
| --- | --- | --- | --- |
...
All tags belong to `ghcr.io/closure-labs/finbox`. Shared modules manage system
